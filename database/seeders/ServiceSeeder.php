    ...
    public function run(): void
    {
        $items = [
            [
                ...
                'title' => [
                    'en' => 'Use municipal property',
                    'es' => 'Uso de propiedad municipal',
                ],
                'description' => [
                    'en' => 'Use a municipal property for various purposes. Example: community events, recreational activities, etc.',
                    'es' => 'Uso de una propiedad municipal para diversos fines. Ejemplo: eventos comunitarios, actividades recreativas, etc.',
                ],
                'icon' => 'calendar',
                'account_type_id' => 1,
                'service_type_id' => 4,
            ...
            [
                ...
                'title' => [
                    'en' => 'Rent municipal property',
                    'es' => 'Alquiler de propiedad municipal',
                ],
                'description' => [
                    'en' => 'Rent a municipal property for not licit or commercial use.',
                    'es' => 'Alquiler de una propiedad municipal para uso no lícito o comercial.',
                ],
            ...
            [
                ...
                'title' => [
                    'en' => 'Settlement for Business Construction Permit',
                    'es' => 'Radicación de Permiso de Construcción Comercial',
                ],
                'description' => [
                    'en' => 'Settlement for a permit to carry out construction projects for your business within the municipality.',
                    'es' => 'Radicación de un permiso para llevar a cabo proyectos de construcción para su negocio dentro del municipio.',
                ],
                'icon' => 'barrier-block',
                'account_type_id' => 2,
                'service_type_id' => 2,
            ...
            [
                ...
                'title' => [
                    'en' => 'Settlement for Temporary Business Patent',
                    'es' => 'Radicación de Patente Comercial Temporal',
                ],
                'description' => [
                    'en' => 'Settlement for a temporary patent to operate your business within the municipality.',
                    'es' => 'Radicación de una patente temporal para operar su negocio dentro del municipio.',
                ],
                'icon' => 'id',
                'account_type_id' => 2,
                'service_type_id' => 2,
            ...
            [
                ...
                'title' => [
                    'en' => 'Settlement for Renewal of Business Patent',
                    'es' => 'Radicación de Renovación de Patente Comercial',
                ],
                'icon' => 'certificate',
                'description' => [
                    'en' => 'Settlement for renewal of your existing business patent to continue operating legally within the municipality.',
                    'es' => 'Radicación de renovación de patente comercial existente para continuar operando legalmente dentro del municipio.',
                ],
                'account_type_id' => 2,
                'service_type_id' => 2,
            ],
            [
                ...
                'title' => [
                    'en' => 'Settlement for Business Tax Report',
                    'es' => 'Radicación de Informe de Impuestos Comerciales',
                ],
                'description' => [
                    'en' => 'Settlement for business tax report for the specified tax period as required by municipal regulations.',
                    'es' => 'Radicación de informe de impuestos comerciales para el período fiscal especificado según lo requerido por las regulaciones municipales.',
                ],
                'icon' => 'recipt-tax',
                'account_type_id' => 2,
                'service_type_id' => 2,
