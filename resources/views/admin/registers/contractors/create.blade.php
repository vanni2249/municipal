                            ...
                            <div class="grid grid-cols-12 gap-4 lg:gap-8">
                                <div class="col-span-full lg:col-span-5">
                                    ...
                                    <p class="text-xs text-gray-500 py-4">
                                        Debe colocar la informacion personal del contratista, esta informacion es necesaria
                                        para poder
                                        identificar al contratista y realizar el trabajo de manera correcta.
                                    </p>
                                </div>
                                ...
                                <div class="col-span-full lg:col-span-5">
                                    ...
                                    <p class="text-xs text-gray-500 py-4">
                                        Debe colocar la informacion de contacto del contratista, esta informacion es necesaria
                                        para poder
                                        comunicarnos con el contratista y realizar el trabajo de manera correcta.
                                    </p>
                                </div>
                                <div class="col-span-full lg:col-span-7">
                                    <div>
                                ...
                                <div class="col-span-full lg:col-span-5">
                                    ...
                                    <p class="text-xs text-gray-500 py-4">
                                        Debe colocar la dirreccion postal del contratista, esta informacion es necesaria
                                        para poder
                                        enviarle notificaciones y comunicarnos con el contratista de manera correcta.
                                    </p>
                                </div>
                                <div class="col-span-full lg:col-span-7">
                                    <div>
