            ...
            <x-card class="rounded-xl p-4 h-full">
                <header class="flex justify-between items-center mb-6">
                    <h2 class="text-lg font-bold text-gray-900">
                        Registrar persona discapacitada
                    </h2>
                </header>
                <div class="">
                    <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-12 gap-4 lg:gap-8">
                                <div class="col-span-full lg:col-span-5">
                                    ...
                                    <p class="text-xs text-gray-500 py-4">
                                        ...
                                        para poder
                                        identificar al empleado y realizar el trabajo de manera correcta.
                                    </p>
                                </div>
                                ...
                                <div class="col-span-full lg:col-span-5">
                                    ...
                                    <p class="text-xs text-gray-500 py-4">
                                        ...
                                        para poder
                                        comunicarnos con el empleado y realizar el trabajo de manera correcta.
                                    </p>
                                </div>
                                <div class="col-span-full lg:col-span-7">
                                    <div>
                                ...
                                <div class="col-span-full lg:col-span-5">
                                    ...
                                    <p class="text-xs text-gray-500 py-4">
                                        ...
                                        para poder
                                        enviarle notificaciones y comunicarnos con el empleado de manera correcta.
                                    </p>
                                </div>
                                <div class="col-span-full lg:col-span-7">
                                    <div>
