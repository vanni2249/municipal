        ...
        <div class="col-span-full lg:col-span-full">
            <x-card class="h-full rounded-xl">
                <header class="flex justify-between items-center mb-4">
                   <h1 class="text-lg font-bold">Personas discapacitadas</h1> 
                    <x-icon-link href="{{ route(request()->segment(1) . '.registers.disabled-people.create') }}" icon="plus" />
                ...
                <x-table>
                    <x-slot name="head">
                        <tr>
                            ...
                            <th class="p-2 w-auto">Persona</br>Contacto</th>
                            <th class="p-2 w-auto">Email</br>Contacto</th>
                            <th class="p-2 w-auto">Telefono<br/>Contacto</th>
                    ...
                    <x-slot name="body">
                        ...
                        <tr class="border-t border-gray-200">
                            ...
                            <td class="px-2 py-1">Jose A. Zayas</td>
                            ...
                            <td class="px-2 py-1 flex justify-end">
                                <x-icon-link href="{{ route(request()->segment(1) . '.registers.disabled-people.show', ['people' => 1]) }}" icon="eye" />
                            </td>
                        </tr>
                        @endfor
                    </x-slot>
