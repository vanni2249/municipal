        ...
        <div class="col-span-full lg:col-span-full">
            <x-card class="rounded-xl">
                <header class="flex justify-between items-center">
                    <h3 class="font-bold text-lg text-gray-800">Detalles de la persona discapacitada</h3>
                        <x-icon-link href="{{ route(request()->segment(1) . '.registers.disabled-people.edit' , ['people' => 1]) }}"></x-icon-link>
