                            ...
                            <div class="grid grid-cols-12 gap-4 lg:gap-8">
                                <div class="col-span-full lg:col-span-5">
                                    ...
                                    <p class="text-xs text-gray-500 py-4">
                                        Debe colocar la informacion personal del empleado, esta informacion es necesaria
                                        para poder
                                ...
                                <div class="col-span-full lg:col-span-5">
                                    ...
                                    <p class="text-xs text-gray-500 py-4">
                                        Debe colocar la informacion de contacto del empleado, esta informacion es necesaria
                                        para poder
                                ...
                                <div class="col-span-full lg:col-span-5">
                                    ...
                                    <p class="text-xs text-gray-500 py-4">
                                        Debe colocar la dirreccion postal del empleado, esta informacion es necesaria
                                        para poder
