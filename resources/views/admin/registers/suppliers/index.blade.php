        ...
        <div class="col-span-full lg:col-span-full">
            <x-card class="h-full rounded-xl">
                <header class="flex justify-between items-center mb-4">
                   <h1 class="text-lg font-bold">Suplidores</h1> 
                    <x-icon-link href="{{ route(request()->segment(1) . '.registers.suppliers.create') }}" icon="plus" />
                    ...
                    <x-slot name="body">
                        ...
                        <tr class="border-t border-gray-200">
                            ...
                            <td class="px-2 py-1 flex justify-end">
                                <x-icon-link href="{{ route(request()->segment(1) . '.registers.suppliers.show', ['supplier' => 1]) }}" icon="eye" />
                            </td>
                        </tr>
                        @endfor
                    </x-slot>
