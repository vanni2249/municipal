                            ...
                            <div class="grid grid-cols-12 gap-4 lg:gap-8">
                                <div class="col-span-full lg:col-span-5">
                                    ...
                                    <p class="text-sm text-gray-500 py-4">
                                        Debe colocar la informacion personal de la persona mayor, esta informacion es necesaria
                                        para poder
                                        identificar al persona mayor y realizar el trabajo de manera correcta.
                                    </p>
                                </div>
                                ...
                                <div class="col-span-full lg:col-span-5">
                                    ...
                                    <p class="text-sm text-gray-500 py-4">
                                        Debe colocar la informacion de contacto de la persona mayor, esta informacion es necesaria
                                        para poder
                                        comunicarnos con la persona mayor y realizar el trabajo de manera correcta.
                                    </p>
                                </div>
                                <div class="col-span-full lg:col-span-7">
                                    <div>
                                ...
                                <div class="col-span-full lg:col-span-5">
                                    ...
                                    <p class="text-sm text-gray-500 py-4">
                                        Debe colocar la dirreccion postal de la persona mayor, esta informacion es necesaria
                                        para poder
                                        enviarle notificaciones y comunicarnos con la persona mayor de manera correcta.
                                    </p>
                                </div>
                                <div class="col-span-full lg:col-span-7">
                                    <div>
