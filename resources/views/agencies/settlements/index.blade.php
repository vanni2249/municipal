<x-layouts.agencies>
    <div class="grid grid-cols-12 px-4">
        {{-- <header class="col-span-full flex items-center justify-between">
            <x-title title="Radicaciones" />
        </header> --}}
        <div class="col-span-full lg:col-span-full">
            <x-card class="h-full rounded-xl">
                <header class="flex justify-between items-center mb-4">
                   <h1 class="text-lg font-bold">Radicaciones</h1> 
                ...
                <x-table>
                    ...
                    <x-slot name="body">
                        @foreach (App\Data\Settlement::items() as $item)
                        ...
                        <tr class="border-t border-gray-200">
                            ...
                            <td class="px-4 py-1 flex justify-end">
                                <x-icon-link href="{{ route(request()->segment(1) . '.settlements.show' ,['settlement' => 1]) }}" icon="eye" />
                            </td>
                        </tr>
                        @endforeach
                    </x-slot>
            ...
            <x-card>
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <div class="bg-gray-100 col-span-2 rounded-md">
                        ...
                        @php
                            $interactions = [
                                ['title' => 'Radicación de permiso de construcción', 'count' => 100],
                                ['title' => 'Radicación de permiso de uso', 'count' => 75],
                                ['title' => 'Radicación de patente temporera', 'count' => 50],
                                ['title' => 'Radicación de patente oficial', 'count' => 25],
                                ['title' => 'Radicación de renovación de patente', 'count' => 15],
                            ];
                        @endphp
