<x-layouts.auth>
    <div class="bg-white w-full sm:w-sm rounded p-4">
        <div class="">
            ...
            <p class="mt-1 text-sm text-gray-600">¡Bienvenido de nuevo! Inicia sesión en tu cuenta de <b>comerciante</b>.</p>
        </div>
        <div class="mt-4">
        ...
        <div class="mt-6">
            <p class="mt-4 text-xs text-gray-600">
                ...
                <a href="{{ route('merchants.register') }}"
                    class="text-blue-500 hover:text-blue-700 text-xs">Regístrar una cuenta de comerciante</a>
        </div>
    </div>
</x-layouts.auth>