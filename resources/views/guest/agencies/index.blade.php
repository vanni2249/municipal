<x-layouts.guest>
     <section class="grid grid-cols-12 gap-4 max-w-7xl mx-auto p-4">
        <header class="col-span-full flex justify-between items-center">
                <x-title title="Entidades municipales" />
            </header>
        ...
        <ul class="col-span-full grid grid-cols-12 gap-4">
            ...
            <li class="col-span-full md:col-span-6 lg:col-span-4">
                <a href="{{ route('agencies.show', ['agency' => $item['slug']]) }}"
                    class="bg-white hover:shadow h-full p-8 rounded flex flex-row items-center space-x-4">
                    <span>
