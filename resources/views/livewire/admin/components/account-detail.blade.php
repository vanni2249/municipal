<div>
    <x-card>
        ...
        <x-card-body-grids>
            <!-- Number -->
            <x-card-body-grid label="Número" value="{{ $account->number ?? 'N/A' }}" class="col-span-full lg:col-span-6" />
            ...
            <x-card-body-grid label="Nombre completo"
                ...
                <!-- Phone -->
                <x-card-body-grid label="Teléfono" value="{{ $account->user_id ? $account->user->phone ?? '...' : $account->phone ?? '...' }}"
                class="col-span-full md:col-span-6" />
