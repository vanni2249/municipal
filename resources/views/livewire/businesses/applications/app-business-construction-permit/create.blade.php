        ...
        <form wire:submit.prevent="store">
            <x-form-elements>
                ...
                <x-form-element class="col-span-full lg:col-span-6 lg:col-start-1">
                    ...
                    <x-textarea id="project_description" wire:model="project_description" @class(['w-full', 'border-red-500' => $errors->has('project_description')]) rows="4" />
                ...
                <x-form-element class="col-span-full lg:col-span-6 lg:col-start-1">
                    ...
                    <x-input id="contractor_license_number" type="text" wire:model="contractor_license_number" @class(['w-full', 'border-red-500' => $errors->has('contractor_license_number')]) />
