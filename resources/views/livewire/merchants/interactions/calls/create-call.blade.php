        ...
        <div class="space-y-8">
            <div class="grid grid-cols-12 gap-4 lg:gap-8">
                ...
                <div class="col-span-full lg:col-span-5">
                    <h2 class="text-sm font-bold text-gray-600">Numero de telefono</h2>
                    <p class="text-xs text-gray-500">
                        Debe colocar el numero de telefono de la persona que solicita el servicio, esta informacion es
                        necesaria para poder comunicarnos con ella.
                    </p>
                </div>
                <div class="col-span-full lg:col-span-7">
                    <div class="w-full md:w-1/2">
                        <x-label for="code" value="Numero de telefono" />
