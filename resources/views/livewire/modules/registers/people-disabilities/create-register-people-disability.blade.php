        ...
        <div class="grid grid-cols-12 gap-4 lg:gap-8">
            ...
            <div class="col-span-full lg:col-span-7">
                <div>
                    ...
                    <x-input id="address" type="text" class="mt-1 block w-full" wire:model.defer="merchant.address" />
                </div>
                <div>
                ...
                <div class="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4">
                    <div class="w-full md:w-1/2">
                        ...
                        <x-input id="state" type="text" class="mt-1 block w-full" wire:model.defer="merchant.state" />
                    </div>
            ...
            <div class="col-span-full lg:col-span-7">
                ...
                <div class="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4">
                    <div class="w-full md:w-1/2">
                        ...
                        <x-input id="email" type="email" class="mt-1 block w-full" wire:model.defer="merchant.email" />
                    </div>
                </div>
