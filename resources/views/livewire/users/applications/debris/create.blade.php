    ...
    <div class="p-4">
        <x-card>
            <header class="flex justify-between items-center mb-4">
                <h2 class="text-lg font-bold">Solicitar recogido de escombros</h2>
            </header>
            <div>
                    ...
                    <div class="grid grid-cols-6 gap-4">
                        ...
                        <div class="col-span-full lg:col-span-4 grid grid-cols-2 gap-4">
                            ...
                            <div class="col-span-full">
                                ...
                                <x-input wire:model="address" type="text" name="address" id="address"
                                    class="w-full" />
                                @error('address')
                                    <x-error message="{{ $message }}" />
                                @enderror
                            ...
                            <div class="col-span-full lg:col-span-1">
                                ...
                                <x-input wire:model="city" name="city" id="city" type="text"
                                    class="w-full" />
                            </div>
                            ...
                            <div class="cols-span-full lg:col-span-1">
                                ...
                                <x-input wire:model="postal_code" name="postal_code" id="postal_code" type="text"
                                    class="w-full" />
                            </div>
                        ...
                        <div class="col-span-full lg:col-span-4 grid grid-cols-2 gap-4">
                            <!-- Service Type -->
                            <div class="col-span-full md:col-span-1 md:col-start-1">
                                <x-label for="debris_type_id" value="Tipo de escombro" />
                                <x-select class="w-full" id="debris_type_id" name="debris_type_id" wire:model.defer="debris_type_id">
                                    <option value="">Seleccione tipo de escombro</option>
                                    @foreach ($debris as $item)
                                        <option value="{{ $item->id }}">{{ $item->es_name }}</option>
                                    @endforeach
                                </x-select>
                                @error('debris_type_id')
                                    <x-error message="{{ $message }}" />
                                @enderror
                            </div>
                            <!-- Description -->
