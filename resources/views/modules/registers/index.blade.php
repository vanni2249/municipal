                ...
                <div class="grid grid-cols-2 gap-4">
                    @php
                        $items = [
                            ...
                            ['title' => 'Usuarios', 'value' => '123', 'span' => 1],
                            ['title' => 'Comerciante', 'value' => '1,500', 'span' => 1],
                        ];
                    @endphp
                    ...
                    <div class="bg-gray-100 col-span-2 rounded-md">
                        ...
                        @php
                            $interactions = [
                                ['title' => 'Usuarios', 'count' => 10],
                                ['title' => 'Comerciantes', 'count' => 5],
                                ['title' => 'Contables', 'count' => 3],
                                ['title' => 'Contratistas', 'count' => 2],
                                ['title' => 'Supplidores', 'count' => 1],
                                ['title' => 'Edad avanzada', 'count' => 1],
                                ['title' => 'Discapacidad', 'count' => 1],
                            ];
                        @endphp
