                ...
                <x-table>
                    <x-slot name="head">
                        <tr>
                            ...
                            <th class="p-2 w-1/6">Numero</th>
                            <th class="p-2 w-1/6">Categoria</th>
                            <th class="p-2 w-1/6">Status</th>
                            <th class="p-2 w-1/6">Creado por</th>
                            <th class="p-2 w-1/6">Fecha creacion</th>
                    ...
                    <x-slot name="body">
                        ...
                        <tr class="border-t border-gray-200">
                            ...
                            <td class="px-2 py-1">{{ $item['created_at'] }}</td>
                ...
                <div class="grid grid-cols-2 gap-4">
                    @php
                        $items = [
                            ...
                            ['title' => 'En proceso', 'value' => '123', 'span' => 1],
                            ['title' => 'Completados', 'value' => '1,500', 'span' => 1],
                        ];
                    @endphp
