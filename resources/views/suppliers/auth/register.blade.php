...
<div class="bg-white w-full sm:w-sm rounded p-4">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">¡Bienvenido! Registro de <b>suplidor</b> de la
        ...
        <div class="mt-6">
            <p class="mt-4 text-xs text-gray-600">¿Ya tienes una cuenta? <a href="{{ route('suppliers.login') }}"
