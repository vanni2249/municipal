<x-layouts.auth>
    <div class="bg-white w-full sm:w-sm rounded-2xl p-4">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">¡Bienvenido! Registro de <b>ciudadanos</b> y <b>visitantes</b> de la
        ...
        <div class="mt-2 flex items-center space-x-2">
            ...
            <x-label for="terms" value="Soy residente de la ciudad de San Antonio." />
        </div>
        <div class="mt-8">
