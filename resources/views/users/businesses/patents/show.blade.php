            ...
            <div class="col-span-full lg:col-span-full space-y-4">
                ...
                <x-card class="rounded-xl">
                    ...
                    <div class="col-span-full space-y-2">
                        @for ($i = 0; $i < 2; $i++) 
                        <a href="{{ route(request()->segment(1) . '.businesses.patents.periods.show', ['business' => 1, 'patent' => 1, 'period' => 1]) }}" class="bg-gray-100 hover:bg-gray-200 block p-2 md:p-4 rounded-xl">
