                ...
                <x-card color="bg-blue-300" class="rounded-xl">
                    <header class="flex flex-col md:flex-row md:justify-between md:items-center space-y-4 md:space-y-0">
                        <h2 class="text-lg font-bold text-gray-900">
                            Imprimir el permiso de uso
                        </h2>
                        <div class="flex items-center space-x-2">
                            <x-button href="#" class="bg-blue-500 hover:bg-blue-600 w-full text-white">
                               Imprimir
                            </x-button>
                            {{-- <x-button href="#" class="bg-green-500 hover:bg-green-600 w-full text-white">
                               Descargar
                            </x-button> --}}
                        </div>
                    </header>
