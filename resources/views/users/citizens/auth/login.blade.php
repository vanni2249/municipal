<x-layouts.auth>
    <div class="bg-white w-full sm:w-sm rounded p-4">
        <div class="">
            ...
            <p class="mt-1 text-sm text-gray-600">¡Bienvenido de nuevo! Inicia sesión en tu cuenta de ciudadano.</p>
        </div>
        <div class="mt-4">
            <x-label for="email" class="mt-4" value="Email" />
            <x-input id="email" class="w-full" type="email" name="email" placeholder="Enter your email" required autofocus />
        </div>
        <div class="mt-2">
