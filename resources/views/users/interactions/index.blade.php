                ...
                <x-card class="rounded-xl p-4 h-full">
                    <header
                        ...
                        <div class="flex lg:hidden space-x-2">
                            <div class="flex">
                                <a href="{{ route(request()->segment(1) . '.interactions.calls.create') }}" class="bg-gray-100 hover:bg-gray-300 p-2 rounded-full">
                                    <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-phone"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 4h4l2 5l-2.5 1.5a11 11 0 0 0 5 5l1.5 -2.5l5 2v4a2 2 0 0 1 -2 2a16 16 0 0 1 -15 -15a2 2 0 0 1 2 -2" /></svg>
                                </a>
                            </div>
                            <div class="flex">
                                <a href="{{ route(request()->segment(1) . '.interactions.messages.create') }}" class="bg-gray-100 hover:bg-gray-300 p-2 rounded-full">
                     ...
                     <div class="col-span-full space-y-2">
                        ...
                        @endphp
                        <a href="{{ route( request()->segment(1) . '.interactions.' .$interaction .'s.show' , [ $interaction => $i]) }}" class="bg-gray-100 hover:bg-gray-200 block p-2 md:p-4 rounded-xl">
                                ...
                                <ul class="text-sm pt-2">
                                    ...
                                    <li class="text-xs text-gray-600 flex space-x-4">
                                        @switch($i)
                                            ...
                                            @default
                                            hace {{ rand(1, 12) }} horas &bull; Finanzas
                                        @endswitch
                                    </li>
                                </ul>
                            </div>
