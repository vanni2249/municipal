            ...
            <div class="col-span-full md:col-span-8">
                <x-card class="rounded-xl p-4 h-full">
                        ...
                        <div>
                            <x-dropdown align="right" width="72">
                                <x-slot name="trigger">
                                 ...
                                 <x-slot name="content">
                                    <x-dropdown-link href="{{ route(request()->segment(1) . '.settlements.building-permit.create') }}">
                                        Radicacion de permiso de construccion
                                    </x-dropdown-link>
                                    <x-dropdown-link href="{{ route(request()->segment(1) . '.settlements.use-permit.create') }}">
                    ...
                    <div class="col-span-full space-y-2">
                        @for ($i = 0; $i < 3; $i++) 
                        <a href="{{ route(request()->segment(1) . '.settlements.show', ['settlement' => 1]) }}" class="bg-gray-100 hover:bg-gray-200 flex w-full p-2 md:p-4 rounded-xl">
                            <div class="flex w-full justify-between items-start">
                                ...
                                <div class="line-clamp-1">
                                    <span class="text-xs text-gray-600 whitespace-nowrap">hace 12 horas</span>
                                </div>
                            </div>
                        </a>
                        @endfor
