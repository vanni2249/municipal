                        ...
                        <div>
                            <x-dropdown align="right" width="72">
                                <x-slot name="trigger">
                                 ...
                                 <x-slot name="content">
                                    <x-dropdown-link href="{{ route(request()->segment(1) . '.merchants.create') }}">
                                        Crear comerciante
                                    </x-dropdown-link>
                                </x-slot>
                            </x-dropdown>
                    ...
                    <div class="col-span-full space-y-2">
                        ...
                        <a href="{{ route(request()->segment(1) . '.merchants.show', ['merchant' => 1]) }}" class="bg-gray-100 hover:bg-gray-200 block w-full p-2 md:p-4 rounded-xl">
                            ...
                            <div class="flex w-full justify-between items-start">
                                <ul class="text-sm">
                                    <li class="text-gray-800 text-md font-bold ">Jose A Colon Santiago</li>
                                    <li class="text-xs text-gray-600">{{ rand(1,5) }} comercios</li>
                                </ul>
                            </div>
                        </a>
                        @endfor
