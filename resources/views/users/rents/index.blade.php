            ...
            <div class="col-span-full lg:col-span-8">
                <x-card class="rounded-xl p-4 h-full">
                    <header class="flex flex-row justify-between items-center space-x-4 mb-4">
                        ...
                        <div>
                            <x-dropdown align="right" width="72">
                                ...
                                <x-slot name="content">
                                    <x-dropdown-link
                                        href="{{ route(request()->segment(1) . '.rents.facilities.create') }}">
                                        Renta de facilidad para actividades privadas
                                    </x-dropdown-link>
                                </x-slot>
                            </x-dropdown>
                        </div>
                    ...
                    <div class="col-span-full">
                        <div class="space-y-2">
                            @for ($i = 0; $i < 4; $i++)
                                <a href="{{ route(request()->segment(1) . '.rents.show', ['rent' => 1]) }}"
                                    ...
                                    <ul class="text-sm pt-2">
                                        <li class="text-gray-800 text-md font-bold ">Renta de Usos Multiples</li>
                                        <li class="text-xs text-gray-600">12/16/2025 &bull; Cumpleanos</li>
                                    </ul>
                                </a>
                            @endfor
                        </div>
