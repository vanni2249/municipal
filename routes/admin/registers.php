...
Route::prefix('/registers')->name('registers.')->group(function () {
    ...
    Route::prefix('/contractors')->name('contractors.')->group(function () {
        Route::get('/', function () {
            return view('admin.registers.contractors.index');
        })->name('index');
        Route::get('/create', function () {
            return view('admin.registers.contractors.create');
        })->name('create');
        Route::get('/{contractor}', function () {
            return view('admin.registers.contractors.show');
        })->name('show');
        Route::get('/{contractor}/edit', function () {
            return view('admin.registers.contractors.edit');
        })->name('edit');
    });

    Route::prefix('/suppliers')->name('suppliers.')->group(function () {
        Route::get('/', function () {
            return view('admin.registers.suppliers.index');
        })->name('index');
        Route::get('/create', function () {
            return view('admin.registers.suppliers.create');
        })->name('create');
        Route::get('/{supplier}', function () {
            return view('admin.registers.suppliers.show');
        })->name('show');
        Route::get('/{supplier}/edit', function () {
            return view('admin.registers.suppliers.edit');
        })->name('edit');
    });

    Route::prefix('/seniors')->name('seniors.')->group(function () {
        Route::get('/', function () {
            return view('admin.registers.seniors.index');
        })->name('index');
        Route::get('/create', function () {
            return view('admin.registers.seniors.create');
        })->name('create');
        Route::get('/{senior}', function () {
            return view('admin.registers.seniors.show');
        })->name('show');
        Route::get('/{senior}/edit', function () {
            return view('admin.registers.seniors.edit');
        })->name('edit');
    });

    Route::prefix('/disabled-people')->name('disabled-people.')->group(function () {
        Route::get('/', function () {
            return view('admin.registers.disabled-people.index');
        })->name('index');
        Route::get('/create', function () {
            return view('admin.registers.disabled-people.create');
        })->name('create');
        Route::get('/{people}', function () {
            return view('admin.registers.disabled-people.show');
        })->name('show');
        Route::get('/{people}/edit', function () {
            return view('admin.registers.disabled-people.edit');
        })->name('edit');
    });
});
